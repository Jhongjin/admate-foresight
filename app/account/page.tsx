    ...
    <div className="mx-auto flex min-h-[calc(100vh-10rem)] w-full max-w-4xl flex-col justify-center px-4 py-10 sm:px-6 sm:py-12">
      <section className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          <Link
            href={returnPath}
            className="flex min-h-11 flex-1 items-center justify-center rounded-lg bg-gray-900 px-4 py-3 text-sm font-semibold text-white hover:bg-gray-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2"
          >
            {returnLabel}
          </Link>
          <a
        ...
        <div className="mt-6 flex flex-col gap-2 border-t border-gray-100 pt-6 sm:flex-row sm:flex-wrap">
          {secondaryActions.map((action) => (
            <Link
              key={action.href}
              href={action.href}
              className="flex min-h-10 items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2"
            >
              {action.label}
            </Link>
          ))}
